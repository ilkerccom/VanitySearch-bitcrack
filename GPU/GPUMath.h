...
#define Load256A(r, a) {\
  (r)[0] = (a)[IDX]; \
  (r)[1] = (a)[IDX+NUM_THREADS_PER_BLOCK]; \
  (r)[2] = (a)[IDX+2*NUM_THREADS_PER_BLOCK]; \
  (r)[3] = (a)[IDX+3*NUM_THREADS_PER_BLOCK];}

// ---------------------------------------------------------------------------------------

#define Store256A(r, a) {\
  (r)[IDX] = (a)[0]; \
  (r)[IDX+NUM_THREADS_PER_BLOCK] = (a)[1]; \
  (r)[IDX+2*NUM_THREADS_PER_BLOCK] = (a)[2]; \
  (r)[IDX+3*NUM_THREADS_PER_BLOCK] = (a)[3];}
